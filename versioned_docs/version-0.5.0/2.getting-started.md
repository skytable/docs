...
A vulnerability has been detected in the `tdb` binary component in this release. Please review [this page](https://skybasedb.github.io/security/ve/s/00001.html) to download a patched binary.
:::
