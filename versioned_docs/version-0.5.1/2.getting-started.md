...
Head over to this [page](https://github.com/skytable/skytable/releases/v0.5.1) and download a version for your platform.
...
``` 
docker create skytable/sdb:v0.5.1 --name skyvm
```
