...
Head over to this [page](https://github.com/terrabasedb/terrabase/releases/v0.4.4) and download a version for your platform.
...
``` 
docker create terrabasedb/tdb:v0.4.4 --name tdbvm
```
