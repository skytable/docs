...
Head over to [this page](https://github.com/skytable/skytable/releases/v0.3.0) and download a version for your platform. Here's a little guide:

* If you're on Linux: Download `tdb-bundle-0.3.0-x86_64-linux-gnu.zip`
* If you're using macOS: Download `tdb-bundle-0.3.0-x86_64-macos.zip`
* If you're on Windows: Download `tdb-bundle-0.3.0-x86_64-windows.zip`
