...
Head over to [this page](https://github.com/skybasedb/skybase/releases/v0.4.0) and download a version for your platform. Here's a little guide:

* If you're on Linux: Download `tdb-bundle-0.4.0-x86_64-linux-gnu.zip`
* If you're using macOS: Download `tdb-bundle-0.4.0-x86_64-macos.zip`
* If you're on Windows: Download `tdb-bundle-0.4.0-x86_64-windows.zip`
