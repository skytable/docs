...
Terrapipe is an application layer protocol, like HTTP, built on top of TCP which is used by [Skytable](https://github.com/terrabasedb/terrabase) for client/server communication. 
All clients willing to communicate with Skytable servers must implement this protocol. This document serves as a guide for implementing clients for Skytable.
