...
Terrapipe is an application layer protocol, like HTTP, built on top of TCP which is used by [Skytable](https://github.com/skytable/skytable) for client/server communication. 
