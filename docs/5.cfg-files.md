...
---
Skytable supports custom configuration files to let users customize the functioning of TDB. Arguably, TDB has one of the simplest configuration files around. Skytable also allows configuration via [command line arguments](config-cmd).
