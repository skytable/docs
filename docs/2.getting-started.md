...
Head over to this [page](https://github.com/skytable/skytable/releases/v0.7.1) and download a version for your platform.
...
```
docker run -d --name skyvm skytable/sdb:v0.7.1
```
